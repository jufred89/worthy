...
<body>
	<div id="header">
		...
		<div class="col-xs-4 col-sm-4" id="menu">
			<div>
				<i class="fa fa-map-marker" aria-hidden="true"></i>
				 <a data-toggle="modal" href="#myModal">어디로 떠날까요?</a>
			
			</div>
			<div>|</div>
			<div>
				<i class="fa fa-calendar-check-o" aria-hidden="true"></i>
				 <a data-toggle="modal" href="#myModal2">언제 떠날까요?</a>
			</div>
		...
		<div class="col-xs-4 col-sm-6" id="search">
			<div>
				<a data-toggle="modal" href="#myModal3">태마검샘 </a>
			</div>
			<div>
				<a href="/info">캠핑정보 </a>
			</div>
            ...
            <div class="modal-dialog">
               ...
               <div class="col-md-1" style="padding: 0;">
                    ...
                    <div class="modal-body" style="height: 300px;">
                       <input type="text" style="border:1px solid gray;"placeholder="원하는 지역을 검색해보세요!">
