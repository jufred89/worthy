...
<body>
	...
	<div class="container">
		<a class="navbar-brand" href="#!">Worthy</a>
						...
						<div class="row">
							<div class="col">
								<input class="form-control form-control-lg" id="emailAddress"
									type="email" placeholder="원하는 지역을 검색해보세요."
		...
		<div class="row g-0">
			...
			<div class="col-lg-6 order-lg-1 my-auto showcase-text">
				...
				<p class="lead mb-0">Landing Page is just HTML and CSS with a
					...
					options. Out of the box, just add your content and images, and your
		...
		<div class="row">
			<div class="col-lg-4">
				<div class="testimonial-item mx-auto mb-5 mb-lg-0">
					...
					<h5>Margaret E.</h5>
					<p class="font-weight-light mb-0">"This is fantastic! Thanks so
						much guys!"</p>
				</div>
			</div>
			<div class="col-lg-4">
