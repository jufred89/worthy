...
<style>
	...
	h5{float:left;margin:3px 10px 20px 10px;}
...
<div id="divRead">
	...
	<form name="frm" action="/recipe/update" method="POST" enctype="multipart/form-data">
		...
		<input type="text" name="fi_title" id="title" style="margin-bottom:15px; width:730px;" value="${vo.fi_title}" placeholder="제목을 입력하세요"/><br/>
			<div id="imageBox">
		...
		<input type="reset" class="whiteBtn" value="수정취소" onClick="location.href='/recipe/list'"/>
		</div>
	</form>
	</div>
</div>
