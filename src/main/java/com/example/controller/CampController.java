...
public class CampController {
	...
	public String campRead(Model model, String camp_id, String reser_checkin, String reser_checkout,
		...
		model.addAttribute("campReviewList", cdao.campReviewList(camp_id));
		String uid = (String) session.getAttribute("uid");
		int check = cdao.campLikeIt(uid, camp_id);
		if (check == 0) {
			cdao.campLikeTableInsert(uid, camp_id);
		}
		model.addAttribute("likeCheck", cdao.campLikeTableCheck(uid, camp_id));
		return "home";
	}
	 ...
	 * public String campReservationCheckoutInsert(HttpSession session, String
	 * camp_id, String style_no, String reser_checkin, String reser_checkout) {
	 * String uid = (String) session.getAttribute("uid"); if (uid != null) {
	 * System.out.println(uid); String camp_room_no = camp_id.concat(style_no);
	 * System.out.println(camp_room_no);
	 * cdao.campReservationCheckoutInsert(camp_id, camp_room_no, reser_checkin,
	 * reser_checkout, uid); } return "redirect:/"; }
	 */
	// 첨부 파일 삭제
	@ResponseBody
	...
	public String kakaoPay(String camp_id, String uid, String style_no, String reser_checkin, String reser_checkout,
			String reser_booker, String reser_booker_phone, String item_name, String total_amount,
			HttpSession session) {
		SSLTrust.sslTrustAllCerts();
		System.out.println(camp_id + "/" + uid + "/" + style_no + "/" + reser_checkin + "/" + reser_checkout + "/"
				+ reser_booker + "/" + reser_booker_phone);
	...
	public String kakaoPayApproval(String pg_token, String tid, Model model, HttpSession httpSession) {
		...
		// System.out.println("kakaoPaySuccess pg_token : " +
		// pg_token.substring(9));
		...
		try {
			...
			InputStreamReader reader = new InputStreamReader(in, "UTF-8"); // 한글깨짐
																			// 방지
			BufferedReader br = new BufferedReader(reader);
			String str = br.readLine();
			System.out.println(str);
	...
	@ResponseBody
	public void kakaoPayApproval(String aid, String pay_date, String pay_type, String quantity, String pay_price,
			String camp_id, String uid, String style_no, String reser_checkin, String reser_checkout,
	...
	public String approval(Model model, String camp_id, String uid, String style_no, String reser_checkin,
			String reser_checkout, String reser_booker, String reser_booker_phone) {
		model.addAttribute("camp_id", camp_id);
	...
	// 캠핑장 좋아요 버튼
	@RequestMapping(value = "/camping/like", method = RequestMethod.POST)
	@ResponseBody
	public void camplike(int likeCheck, String uid, String camp_id) {
		System.out.println("..................................");
		cdao.campLikeTableUpdate(likeCheck, uid, camp_id);
	}
}
